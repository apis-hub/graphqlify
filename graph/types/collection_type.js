import { GraphQLObjectType, GraphQLNonNull, GraphQLString, GraphQLBoolean, GraphQLID, GraphQLScalarType } from "graphql/type";
  ...
  fields: () => ({
    ...
    brandfolder: {
      ...
      resolve: (collection, args) => {
        return collection.__api__.related('brandfolder'), args
      }
    },
    assets: {
      ...
      resolve: (collection, args) => connectionFromPromisedArray(
        collection.__api__.related('assets'), args
      )
    },
    sections: {
      ...
      args: connectionArgs,
      resolve: (collection, args) => connectionFromPromisedArray(
        collection.__api__.related('sections'), args
      )
    },
    admins: {
      type: userConnection,
      ...
      args: connectionArgs,
      resolve: (collection, args) => connectionFromPromisedArray(
        collection.__api__.related('admins'), args
      )
    },
    collaborators: {
      type: userConnection,
      ...
      args: connectionArgs,
      resolve: (collection, args) => connectionFromPromisedArray(
        collection.__api__.related('collaborators'), args
      )
    },
    guests: {
      type: userConnection,
      ...
      args: connectionArgs,
      resolve: (collection, args) => connectionFromPromisedArray(
        collection.__api__.related('guests'), args
      )
    },
    users: {
      type: userConnection,
      ...
      args: connectionArgs,
      resolve: (collection, args) => connectionFromPromisedArray(
        collection.__api__.related('users'), args
      )
    },
    user_permissions: {
...
var {connectionType: collectionConnection, edgeType: GraphQLCollectionEdge} = connectionDefinitions({
  name: 'collection',
