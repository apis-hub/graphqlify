import { GraphQLObjectType, GraphQLInt, GraphQLNonNull, GraphQLString, GraphQLBoolean, GraphQLID, GraphQLScalarType } from "graphql/type";
...
var {connectionType: attachmentConnection, edgeType: GraphQLAttachmentEdge} = connectionDefinitions({
  name: 'attachment',
