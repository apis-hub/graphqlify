import { GraphQLObjectType, GraphQLNonNull, GraphQLString, GraphQLBoolean, GraphQLID } from "graphql/type";
...
var {connectionType: shareManifestConnection, edgeType: GraphQLShareManifestEdge} = connectionDefinitions({
  name: 'shareManifest',
