...
const createEvent = mutationWithClientMutationId({
    ...
    mutateAndGetPayload: ({
        user_id, brandfolder_id, collection_id, asset_id, invitation_id,
        ...
        api.getType('event')
            .create({
                ...
                country: country,
                user_id: localUserId,
                brandfolder_id: localBrandfolderId,
                collection_id: localCollectionId,
                asset_id: localAssetId,
                invitation_id: localInvitationId,
                social_link_id: localSocialLinkId,
                section_id: localSectionId,
                organization_id: localOrganizationId,
                share_manifest_id: localShareManifestId
            })
            .then(result => {
                return {
                    eventId: result.id,
