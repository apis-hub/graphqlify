...
if (_semver2.default.lt(process.version, '4.0.0')) {
  var babelLatest = 'babel-polyfill';
  var babelPrev = 'babel/polyfill';

  var isBabelLatest = require.resolve(babelLatest);
  var isBabelPrev = require.resolve(babelPrev);
